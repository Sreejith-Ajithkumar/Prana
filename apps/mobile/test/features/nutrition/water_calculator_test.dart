...
void main() {
  group('Water Calculator', () {
    ...
    test('calculates daily water target', () {
      final water = calculator.calculate(weightKg: 80);

      expect(water, closeTo(2.64, 0.001));
    });

    test('throws for zero weight', () {
      expect(() => calculator.calculate(weightKg: 0), throwsArgumentError);
    });

    test('throws for negative weight', () {
      expect(() => calculator.calculate(weightKg: -10), throwsArgumentError);
    });
  });
}
